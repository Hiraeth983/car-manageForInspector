    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item menu-open">
                        <a href="queryComplaint.jsp" class="nav-link active">
                    ...
                    <li class="nav-item">
                        <a href="uploadDetectionResult.jsp" class="nav-link">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">查询评价</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid"
                            ...
                            <table class="table my-0" id="dataTable1">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center">申诉</th>
...
<script src="dist/js/pages/queryComplaint.js"></script>
</body>
</html>

    ...
    table.render({
      ...
      ,cols: [[ //表头
        ...
        , {
          ...
          width: 80,
          templet: '<div>' +
                  '<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">申请</button>' +
                  ...
                  '<form class="layui-form" name="carowner" id="carowner" action="" METHOD="POST" onSubmit="return CheckForm();">' +
                  '<div class="layui-form-item">' +
                  '<label class="layui-form-label">单号</label>' +
                  '<div class="layui-input-block">' +
                  '<input id="p1" type="text" name="orderId" lay-verify="required" autocomplete="off" placeholder="请输入身份证号" class="layui-input">' +
                  '</div>' +
                  '</div>' +
                  '<div class="layui-form-item">' +
                  '<label class="layui-form-label">原检测员工</label>' +
                  '<div class="layui-input-block">' +
                  '<input id="p2" type="text" name="oStaffId" lay-verify="required" lay-reqtext="用户名是必填项" placeholder="请输入姓名" autocomplete="off" class="layui-input">' +
                  '</div>' +
                  '</div>' +
                  '<div class="layui-form-item">' +
                  '<label class="layui-form-label">车牌号</label>' +
                  '<div class="layui-input-block">' +
                  '<input id="p3" type="text" name="carId" lay-verify="identity" placeholder="请输入车牌号" autocomplete="off" class="layui-input">' +
                  '</div>' +
                  '</div>' +
                  '<div class="layui-form-item">' +
                  ...
                  '<input type="tel" name="address" lay-verify="required|phone" autocomplete="off" class="layui-input">' +
                  '</div>' +
                  '</div>' +
                  '</div>' +
                  '<div class="modal-footer">' +
                  '<button type="submit" class="layui-btn"  lay-filter="demo1" style="margin-left: 13em;">申请</button>' +

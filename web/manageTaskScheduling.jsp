    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item menu-open">
                        <a href="examineApplication.jsp" class="nav-link active">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">申请调度信息</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 text-nowrap">
                                <button type="button" class="btn btn-danger btn-sm" id="refresh">
                                    刷新
                                </button>
                            </div>
                        </div>
...
<script src="dist/js/pages/manageTaskScheduling.js"></script>
</body>
</html>
